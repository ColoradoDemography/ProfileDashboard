...
introText <- function() {
 ...
 OutText <- paste0(OutText, "  of demographic trends by county and municipality in Colorado.")
 OutText <- paste0(OutText, "  The following collection of data establishes the context for assessing potential impacts and for decision-making.")
 return(OutText)
}
